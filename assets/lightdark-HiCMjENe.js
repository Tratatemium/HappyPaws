...
`;document.querySelector(".sidebar").innerHTML=t;const e=`
        ...
        </ul>`;document.querySelector(".theme-button").innerHTML=e;const s=document.getElementById("themeToggle");s.addEventListener("click",()=>{document.body.dataset.theme=document.body.dataset.theme==="dark"?"light":"dark"});
